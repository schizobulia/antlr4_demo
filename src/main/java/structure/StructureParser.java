...
public class StructureParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "Structure.g4"; }
	...
	public StructureParser(TokenStream input) {
		super(input);
	...
	public static class InitContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof StructureListener ) ((StructureListener)listener).enterInit(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof StructureListener ) ((StructureListener)listener).exitInit(this);
		}
	}
	...
	public static class ValueContext extends ParserRuleContext {
		...
		public TerminalNode INT() { return getToken(StructureParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof StructureListener ) ((StructureListener)listener).enterValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof StructureListener ) ((StructureListener)listener).exitValue(this);
		}
	}
